        ...
        <div className="max-w-md w-full space-y-8">
            ...
            <form onSubmit={onSubmit} className="space-y-6">
                ...
                <div className="relative">
                    ...
                    required
                    className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-600 focus:border-transparent transition duration-150 ease-in-out"
                    placeholder="XXX-XX"
                    />
                </div>
                </div>
                ...
                <div className="relative">
                    ...
                    className="block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-600 focus:border-transparent transition duration-150 ease-in-out"
                    placeholder="••••••••"
                    />
                    <button
                    type="button"
